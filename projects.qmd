...
[Marketing Report →](video-project.qmd){.btn .btn-accent .btn-sm}
:::(projects_files/marketing-strategy.pdf){.btn .btn-accent .btn-sm target="_blank"}
:::

::: {.card .ned-card style="padding:15px; border-radius:10px; box-shadow:0 1.5px 6px var(--accent); text-align:center;"}
![](Images/running-pic.png)
...
[Marketing Video →](https://www.youtube.com/watch?v=nlmdZbdTcnE){.btn .btn-accent .btn-sm target="_blank"}
:::
