...
![](docs/Images/business-people-team-analytics-data-research-web-monitoring-report-dashboard-monitor-concept-finance-investment-graph-r-202761860.webp){style="width:100%; border-radius:6px; margin-bottom:10px;"}
...
::: {.card style="padding:20px; border-radius:10px; box-shadow:0 4px 10px rgba(0,0,0,0.15); margin-bottom:25px;"}
![](docs/Images/download.png){style="width:100%; border-radius:6px; margin-bottom:10px;"}
...
::: {.card style="padding:20px; border-radius:10px; box-shadow:0 4px 10px rgba(0,0,0,0.15); margin-bottom:25px;"}
![](docs/Images/quota_sampling.jpg){style="width:100%; border-radius:6px; margin-bottom:10px;"}
