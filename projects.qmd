...
[Predicting Depression →](projects_files/depression.pdf){.btn .btn-accent .btn-sm target="_blank"}
:::
...
[Feasibility Report →](projects_files/feasibility-analysis.pdf){.btn .btn-accent .btn-sm target="_blank"}
:::
