...
```{python}
#| code-fold: true
#| code-summary: "Show Plotly interactive chart"
#| fig-cap: "Interactive ROC curves. Hover to see exact values"
...
```{python}
#| code-fold: true
#| code-summary: "Show Plotly feature importance code"
#| fig-cap: "Interactive feature importances. Hover to see exact values"
...
fig.update_layout(
    title='Random Forest - Feature Importances (Interactive)',
...
[Read the Full Report →](../../projects_files/depression.pdf){target="_blank"}
