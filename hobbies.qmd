...
<div style="position:relative; max-width:600px; margin:auto; border-radius:10px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.15);">

  <div id="dogCarousel" style="display:flex; transition:transform 0.4s ease;">
    <img src="Images/phoinex_walk.JPG" style="min-width:100%; height:400px; object-fit:cover;">
    <img src="Images/christmas.jpg" style="min-width:100%; height:400px; object-fit:cover;">
    <img src="Images/sitting.jpg" style="min-width:100%; height:400px; object-fit:cover;">
    <img src="Images/race_day.jpg" style="min-width:100%; height:400px; object-fit:cover;">
  </div>
...
function updateCarousel() {
  document.getElementById('dogCarousel').style.transform = `translateX(-${current * 100}%)`;
